interaction.plots<-function(y,...){
  UseMethod("interaction.plots")
}

interaction.plots.default <- function(y, fac1 = NULL, fac2 = NULL, xlab = NULL, xlab2 = NULL, ylab = NULL,
...
interaction.plots.formula<-function(y, data = NULL, xlab = NULL, xlab2 = NULL, ylab = NULL, data.order = TRUE,
  ...
  interaction.plots(y = response, fac1 = fac1, fac2 = fac2, xlab = xlab, xlab2 = xlab2, ylab = ylab,
