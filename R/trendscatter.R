...
trendscatter.default<-function(x, y = NULL, f = 0.5, xlab = NULL, ylab = NULL, ...){
  if(is.null(xlab))
  ...
  plot(x, y, pch = 1, xlab = xlab, ylab = ylab,
       main = paste("Plot of", ylab, "vs.", xlab, "  (lowess+/-sd)"))
  lines(trend, col = "Blue")
  lines(scatter$x, uplim, lty = 2, col = "Red")
  lines(scatter$x, lowlim, lty = 2, col = "Red")
}

trendscatter.formula<-function (x, f = 0.5, data = NULL, xlab = NULL, ylab = NULL, ...)
